...
export default function App() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight:'100vh', background:'#f4f7f2', display:'flex', alignItems:'center', justifyContent:'center', flexDirection:'column', gap:16, fontFamily:"'DM Sans', sans-serif" }}>
        <div style={{ width:52, height:52, borderRadius:14, background:'linear-gradient(135deg, #1a3a1f, #5a8a62)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:26 }}>🌿</div>
